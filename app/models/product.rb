  ...
  def self.datatable(params, user)
    ...
    @products.each do |product|
      ...
      when "statistics"
                ...
                col_2 = product.name+" "+product.product_code+"<br />"+product.product_log_link+"<div>"+product.description+"</div>"
                ...
                item = [
                        ...
                        "<div class=\"text-left #{trashed_class}\"><strong>"+product.name+" "+product.product_code+"</strong><div>"+product.description+"</div>"+'</div>',
