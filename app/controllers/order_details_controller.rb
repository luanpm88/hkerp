class OrderDetailsController < ApplicationController
  ...
  private
    ...
    def order_detail_params
      params.require(:order_detail).permit(:product_price_id, :order_id, :product_id, :quantity, :price, :supplier_price, :product_name, :warranty, :unit, :supplier_id, :product_description)
    end
end
